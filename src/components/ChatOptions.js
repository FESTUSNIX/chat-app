	...
	return (
		<aside className='chat-options'>
			...
			{themes && (showThemePicker || showThemeCreator) && (
				<>
					<Modal show={showThemePicker} setShow={() => setShowThemePicker(false)} disableOCH={showThemeCreator}>
						<ThemePicker themes={themes} chat={chat} setShowThemeCreator={setShowThemeCreator} />
					</Modal>
					<Modal show={showThemeCreator} setShow={() => setShowThemeCreator(false)}>
						<ThemeCreator
